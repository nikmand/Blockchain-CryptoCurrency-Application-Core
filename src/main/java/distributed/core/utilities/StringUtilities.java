...
public class StringUtilities {
	...
	/*
	 * applyECDSASig takes in the senders private key and string input, signs it and
	 * returns an array of bytes. verifyECDSASig takes in the signature, public
	 * keyand string data and returns true or false if the signature is valid.
